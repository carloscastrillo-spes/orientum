...
function contexto(tipo, msg) {
  ...
  if (tipo === 'red') { return 'Hay una consulta sobre relaciones o datos. Identifica que elemento conecta las partes y cuanto depende el sistema de el.\n\n' + msg; }
  if (tipo === 'juridico') { return 'Hay una consulta juridica. Responde con claridad. Si hay una estructura de conflicto subyacente, orientala tambien.\n\n' + msg; }
